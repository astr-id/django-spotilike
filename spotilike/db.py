...
def create_artistes():
    artistes_data = [
        ...
        Artiste(nom="Post Malone", avatar="https://i.scdn.co/image/ab6761610000e5eb68f6e5892075d7f22615bd17", biographie="Post Malone est un rappeur et chanteur américain, connu pour ses chansons mêlant rap, pop et rock."),
